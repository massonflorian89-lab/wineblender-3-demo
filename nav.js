...
(function () {
  ...
  const ICON = {
    ...
    intrant:        _IC('<path d="M4.5 3h15"/><path d="M6 3v7l-4 9a1 1 0 0 0 .9 1.4h14.2a1 1 0 0 0 .9-1.4L14 10V3"/><path d="M6.5 14.5h11"/>'),
    ai:             _IC('<path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 0 2h-1v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1H2a1 1 0 0 1 0-2h1a7 7 0 0 1 7-7h1V5.73A2 2 0 0 1 10 4a2 2 0 0 1 2-2Z"/><circle cx="7.5" cy="14.5" r="1.5"/><circle cx="16.5" cy="14.5" r="1.5"/>'),
